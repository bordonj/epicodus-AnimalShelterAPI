...
namespace AnimalShelter.Migrations
{
    ...
    [Migration("20210820214013_SeedData")]
            ...
            modelBuilder.Entity("AnimalShelter.Models.Animal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            AnimalId = 4,
                            Age = "10 years",
                            Description = "This is Luci! Luci is a sweet old soul looking for a home where she can take long cat naps and spend time with her trusted humans. She has lived her whole life in one home, so this transition has been difficult for her. Luci will need patient adopters who can give her ample time to adjust. Once she is feeling comfortable, she enjoys gentle petting and taking naps on your lap! Luci would do best in a quiet home, without rambunctious children. She does have some age related medical concerns, such as dental disease, that her adopters will need to keep an eye on. Does this beautiful cat sound like the one for you? Ask an Adoption Counselor to learn more!",
                            Gender = "Female",
                            Name = "Potato",
                            Size = "Medium",
                            Species = "Pig"
                        ...
                        new
                        {
                            AnimalId = 7,
                            Age = "1 years",
                            Description = "Hermione has been a bit shy while in SDHS care but is becoming more social as she gets comfortable. She's very food motivated and really loves her peanut butter and veggies!",
                            Gender = "Female",
                            Name = "Hermione",
                            Size = "Large",
                            Species = "Pig"
